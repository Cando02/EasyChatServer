...
## 项目简介
基于 epoll + 线程池的高性能即时通讯服务器，支持千级并发连接。项目采用跨平台开发模式，在Windows环境下使用CLion进行代码编写和调试，通过远程连接在Ubuntu服务器上运行部署。

### 开发架构
- **开发环境**：Windows 10/11 + CLion 2023+
- **运行环境**：Ubuntu 18.04+
- **远程开发**：通过CLion的远程开发功能实现Windows开发、Ubuntu部署的高效开发流程
- **构建系统**：CMake 3.16+，支持跨平台编译
...
### 6. 跨平台开发架构
- Windows环境下使用CLion进行代码编写和调试
- 通过CLion的远程开发功能连接Ubuntu服务器
- 在Ubuntu环境下编译和运行
- CMake构建系统，支持跨平台编译
